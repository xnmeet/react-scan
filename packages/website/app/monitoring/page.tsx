      ...
      <div className="max-w-[2560px] mx-auto px-4 lg:px-8">
        ...
        <div className="mt-4 text-center">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm text-black  transition-colors"
          >
            This is a preview. <span className="text-scan-600 hover:text-scan-700 transition-colors ">View full page</span>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.5 3C3.5 2.72386 3.72386 2.5 4 2.5H8.5C8.77614 2.5 9 2.72386 9 3V7.5C9 7.77614 8.77614 8 8.5 8C8.22386 8 8 7.77614 8 7.5V4.20711L3.85355 8.35355C3.65829 8.54882 3.34171 8.54882 3.14645 8.35355C2.95118 8.15829 2.95118 7.84171 3.14645 7.64645L7.29289 3.5H4C3.72386 3.5 3.5 3.27614 3.5 3Z" fill="currentColor" className="text-scan-600 hover:text-scan-700 transition-colors"/>
            </svg>
          </Link>
        </div>
      </div>
