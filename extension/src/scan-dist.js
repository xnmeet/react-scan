...
!(function (e) {
      ...
      switch (typeof e) {
        ...
        case 'object':
          ...
          if (
            ...
            'Symbol(react.element)' === String(e.$$typeof)
          )
            return `<${null != (t = S(e.type)) ? t : ''}${Object.keys(e.props || {}).length > 0 ? ' …' : ''}>`;
          if ('object' == typeof e && null !== e && e.constructor === Object) {
            for (const t in e)
    ...
    T = (e) => {
      ...
      if (
        ...
        !((e) => {
          ...
          if (!e) return !0;
          const o =
              (null == (t = e.alternate) ? void 0 : t.memoizedProps) || {},
            l = e.memoizedProps || {},
            i = !(
              1 &
              ~(null != (r = null != (n = e.flags) ? n : e.effectTag) ? r : 0)
            );
          switch (e.tag) {
            case 1:
            case 0:
            ...
            case 14:
            case 15:
              if ('function' == typeof e.type.compare)
      ...
      const o = [],
        l = ['function', 'object'];
      let i = !1;
      const u = null == (t = e.alternate) ? void 0 : t.memoizedProps,
        a = e.memoizedProps;
      for (const e in s(s({}, u), a)) {
        const t = null == u ? void 0 : u[e],
          n = null == a ? void 0 : a[e];
        if (
          Object.is(t, n) ||
          h.isValidElement(t) ||
      ...
      let c = _(e, (e) => 'string' == typeof e.type);
      if ((c || (c = _(e, (e) => 'string' == typeof e.type, !0)), !c))
        return null;
      const f = c.stateNode;
      ...
      const m = null != (n = S(e.type)) ? n : '',
        y = null == (r = e.updateQueue) ? void 0 : r.memoCache,
        { totalTime: b, selfTime: v } = ((e) => {
          var t, n, r;
          const o = null != (t = null == e ? void 0 : e.actualDuration) ? t : 0;
          let l = o,
            i = null != (n = null == e ? void 0 : e.child) ? n : null;
          for (; o > 0 && null != i; )
            (l -= null != (r = i.actualDuration) ? r : 0), (i = i.sibling);
  ...
  var B = (e = z) => {
    if (!(V = null != e ? e : V).production && '_self' in v) return;
    if (
      N ||
      (() => {
        try {
    ...
    const t = I(),
      n = (() => {
        ...
        let t = 'true' === localStorage.getItem('react-scan-hidden');
        const n = () => {
      ...
      r = (e, r) => {
        ...
        const u = (e) => {
          ...
          if (!n) return null;
          const r =
            null != (t = null == q ? void 0 : q.has(e.type))
              ? t
              : null == q
                ? void 0
                : q.has(e.elementType);
            ...
            if (
              !_(
                ...
                (e) => {
                  var t;
                  const n =
                    null != (t = null == q ? void 0 : q.get(e.type))
                      ? t
                      : null == q
                        ? void 0
                        : q.get(e.elementType);
                  return null == n ? void 0 : n.includeChildren;
                },
                !0,
              ) &&
              !r
  ...
  'undefined' != typeof window && (B(), (window.reactScan = B)),
